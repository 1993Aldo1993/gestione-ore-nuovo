        ...
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-slate-200 mb-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <input type="date" value={data} onChange={(e) => setData(e.target.value)} className="w-full bg-slate-50 p-3 rounded-xl border border-slate-100 font-bold outline-none" />
            </div>
            <div className="space-y-1">
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-black text-slate-400 uppercase ml-1">Ore Lavorate (per tutti i selezionati)</label>
